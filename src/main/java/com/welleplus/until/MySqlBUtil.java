...
public class MySqlBUtil {
	...
	static{
		...
		try {
			...
			prop.load(MySqlBUtil.class.getClassLoader().getResourceAsStream("configbf.properties"));
...
//			ds.setMaxWait(maxWait);
	...
	public static void main(String[] args) throws Exception {
		Connection conn = MySqlBUtil.getConnection();
		System.out.println(conn);
		MySqlBUtil.closeConnection(conn);
	}
}
